...
void draw_detections_v4_depth(image im, detection *dets, float thresh, char **names, image **alphabet, int classes, int ext_output, detection_with_class* selected_detections, int selected_detections_num);
